...
export default function TracksIndex() {
  ...
  // Build list data with a final "buy" row
  const data = useMemo(() => {
    return [...tracks.map((t) => ({ type: 'track' as const, track: t })), { type: 'buy' as const }]
  }, [tracks])
  ...
  return (
    <View style={styles.screen}>
      ...
      <FlatList
        data={data}
        keyExtractor={(item, index) => (item.type === 'track' ? item.track.id : `buy_${index}`)}
                ...
                <View style={styles.cardInner}>
                  <View style={styles.left}>
                    ...
                    <View style={styles.metaRow}>
                      ...
                      <Text style={styles.metaText}>Add a new track to your company</Text>
                    </View>
                  </View>

                  <View style={styles.right}>
                    <View style={styles.ratingPill}>
                      <Text style={styles.ratingText}>{formatMoney(nextCost)}</Text>
